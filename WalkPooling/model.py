...
class LinkPred(MessagePassing):
    ...
    #     x, edge_index, edge_mask, batch, z = data.x, data.edge_index, data.edge_mask, data.batch, data.z
        #using drnl
        if self.drnl == True:
        ...
        return out.double(), feature_list.double()
...
class MLP(torch.nn.Module):
    ...
    def __init__(self,input_size,MSE=True):
        ...
        self.norm_l = nn.LayerNorm(input_size)
